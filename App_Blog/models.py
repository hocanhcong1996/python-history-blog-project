...
class Blog(models.Model):
    '''
    Tạo Entity Blog gồm các thuộc tính cần có của một blog
...
class Comment(models.Model):
    '''
    Tạo Entity Comment gồm các thuộc tính cần có của một Comment

            Input:
                    Kế thừa Model có sẵn từ thư viện Django

            Output:
                    Comment Entity có các thuộc tính: 
...
class Likes(models.Model):
    '''
    Tạo Entity Like gồm các thuộc tính cần có của một Like

            Input:
                    Kế thừa Model có sẵn từ thư viện Django

            Output:
                    Like Entity có các thuộc tính: 
